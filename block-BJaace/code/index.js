...
colours[colours.length - 1] = "ultaviolet";
...
delete colours[colours.length - 1];
// 15. Remove the second color from the end of list.
delete colours[colours.length - 2];
...
let lastColor = colours[colours.length - 1];
